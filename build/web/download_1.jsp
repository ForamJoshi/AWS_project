...
<html>
    ...
    <form action="CreateExcel" name="mainForm" method="POST" id ="mainForm1">
         ...
         <td align="left" class="style2">Loacation :</td>
          ...
          <%} catch (Exception e) {
            ...
            %>
                                    ...
                                    <tr>
                                <td colspan="4">Select All Cities : <input type="checkbox" checked="checked" name="allcities" onclick="disabledcities()" /></td>
                                    <tr>
                                <td colspan="4">&nbsp;</td>
                            </tr>
                                    <tr>
                                        ...
                                        <td>  
                                            <input autocomplete="off" readonly="readonly" name="txtFromDate" id="datepicker2" size="24" type="text" onchange="fillTime()"/>
                                        </td>
                                        <td width="15px">&nbsp;</td>             
                                        <td class="style2">To Date :</td>
                                        <td>  
                                           <input autocomplete="off" readonly="readonly" name="txtToDate" id="datepicker3" size="20" type="text" onchange="fillTime()"/>
                                        </td>  
                                    </tr>
                                    <tr></tr>
                                    <tr>
                            ...
                            <td align="right">
                               <input type="submit" value="ViewData" class="send_button" onclick="return Submit()"/>
                                   ...
                                   <td>
                                       <input type="submit" value="Download" class="send_button" onclick="return Submit()"/>
