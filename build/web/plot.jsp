...
<html>
        ...
        <script type="text/javascript">
            ...
            function getStation1(){
               ...
               // System.out.println("coordinatestate"+sta);
                ...
                // alert(dist);
                var url="./getStation_1.jsp?State="+sta;
    ...
    <form action="kavachart.jsp" target="kavachart" name="mainForm" method="POST" id ="mainForm1">
      ...
      <td> <div id="stations123" >
          ...
          <%} catch (Exception e) {
            ...
            %>
                                ...
                                <td colspan="4">&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>  
                                            <input autocomplete="off" readonly="readonly" name="txtFromDate" id="datepicker2" size="24" type="text" onchange="fillTime1()"/>
                                        </td>
                                        <td width="15px">&nbsp;</td>             
                                        <td class="style2">To Date :</td>
                                        <td>  
                                           <input autocomplete="off" readonly="readonly" name="txtToDate" id="datepicker3" size="20" type="text" onchange="fillTime1()"/>
                                        </td>  
                                    </tr>
                                    <tr></tr>
                                    <tr>
                            ...
                            <table align="Center" border="0" > 
                               <tr>
                                ...
                                <td colspan="4">&nbsp;</td>
                                   ...
                                   <td>
                                       <input type="submit" value="Plot" class="send_button" onclick="return Submit1()"/>
            ...
            <table align="center">
                <tr>
                    <td>
            <iframe align="center" name="kavachart" width="600" height="300" frameborder="0">
</iframe> 
</td>
</tr>
</table>
